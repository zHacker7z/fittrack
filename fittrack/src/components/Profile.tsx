...
export function Profile({ username }: ProfileProps) {
  ...
  const colorOptions = [
    { value: "purple", label: "Roxo", gradient: "from-purple-600 to-violet-600", border: "border-purple-500" },
    { value: "blue", label: "Azul", gradient: "from-blue-600 to-cyan-600", border: "border-blue-500" },
    { value: "green", label: "Verde", gradient: "from-green-600 to-emerald-600", border: "border-green-500" },
    { value: "red", label: "Vermelho", gradient: "from-red-600 to-pink-600", border: "border-red-500" },
    { value: "orange", label: "Laranja", gradient: "from-orange-600 to-yellow-600", border: "border-orange-500" },
    { value: "pink", label: "Rosa", gradient: "from-pink-600 to-rose-600", border: "border-pink-500" },
    { value: "black", label: "Preto", gradient: "from-gray-900 to-black", border: "border-gray-700" },
    { value: "white", label: "Branco", gradient: "from-gray-100 to-white", border: "border-gray-300" },
  ];
  ...
  const currentColor = colorOptions.find(c => c.value === profileColor) || colorOptions[0];
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <Card className="bg-gradient-to-br from-purple-900/40 to-violet-900/40 backdrop-blur border-purple-500/30 overflow-hidden">
        <div className={`h-32 bg-gradient-to-r ${currentColor.gradient} relative`}>
          {/* Color Picker Button */}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {colorOptions.map((color) => (
                      ...
                      >
                        ...
                        <p className={`text-sm text-center ${profileColor === color.value ? 'text-white' : 'text-gray-300'}`}>
                          {color.label}
                        </p>
                        {profileColor === color.value && (
